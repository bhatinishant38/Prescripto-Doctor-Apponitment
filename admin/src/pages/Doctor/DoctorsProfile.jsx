...
const DoctorsProfile = () => {
  const { dToken, getDoctorProfileData, doctorProfileData } =
    ...
    doctorProfileData && (
      <div>
        <div className="flex flex-col gap-4 m-5">
          <div >
            <img className="bg-primary/80 w-full sm:max-w-64 rounded-lg" src={doctorProfileData.image} alt="" />
          </div>
          ...
          <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
            ...
            <div className="flex items-center gap-2 mt-1 text-gray-600">
              ...
              <button className="py-0.5 px-2 border text-xs rounded-full">{doctorProfileData.experience}</button>
            </div>

            <div>
              <p className="flex items-center gap-1 text-sm font-medium text-neutral-800 mt-3">About :</p>
              <p className="text-sm text-gray-600 max-w-175 mt-1">{doctorProfileData.about}</p>
            </div>

            <p className="text-gray-600 font-medium mt-4">
              Appointment fee :{" "}
              <span className="text-gray-800">
                {currency} {doctorProfileData.fees}
              </span>
            </p>
