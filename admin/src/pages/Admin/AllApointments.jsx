  ...
  return (
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border border-blue-50 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll">
        <div className="hidden sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 border-b border-blue-50">
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
        ...
        {appointments.map((item, index) => (
          ...
          >
            ...
            </p>           
            {
              ...
              : item.isCompleted ? <p className="text-green-400 text-xs font-medium">Completed</p>:<img
